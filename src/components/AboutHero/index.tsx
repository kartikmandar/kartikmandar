...
export const AboutHero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center px-4 py-8 md:py-0 overflow-hidden">
      <div className="relative max-w-5xl mx-auto w-full mt-16 md:mt-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Column - Profile Photo */}
          <div className="order-2 lg:order-1 flex justify-center lg:justify-center">
            <div className="relative">
              <div className="relative w-80 h-80 md:w-96 md:h-96 lg:w-[450px] lg:h-[450px] overflow-hidden rounded-2xl border border-border">
                <Image
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left flex flex-col justify-center">
            ...
            <div className="mb-10 space-y-4">
              <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                My research centers on 21-cm cosmology, with a focus on forward-modelling interferometric pipelines (visibility simulators, antenna/beam simulations) and validating systematics for experiments like HERA. I also work on time-domain and spectral analysis of black hole X-ray binaries, ML methods for strong gravitational lensing, and open-source scientific software.
              </p>
              <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                I also work as a freelance developer and consultant, building research software, web platforms, and mobile applications for academic and industry clients.
              </p>
            </div>
            ...
            <div className="flex gap-4 justify-center lg:justify-start flex-wrap mb-8">
              <Button 
                size="lg" 
                variant="outline"
                className="min-w-[140px] border-gray-300 dark:border-white"
                onClick={() => {
